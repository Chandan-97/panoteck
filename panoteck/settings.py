"""
Django settings for panoteck project.
...
SECRET_KEY = '_xsa$v!ba7oc(22g2md2id7wulg!wzhu)lj%*3c=*nj@0c%(qh'
...
WSGI_APPLICATION = 'panoteck.wsgi.application'
